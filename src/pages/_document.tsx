...
export default function Document() {
    ...
    return (
        <NextDocument.Html>
            ...
            <link rel="shortcut icon" type="image/vnd.microsoft.icon" href="https://media.example.com/iconFill.ico" />
            ...
            <link rel="apple-touch-icon" href="https://media.example.com/icon.png" />
            <NextDocument.Head />
            <body className="none">
                <NextDocument.Main />
